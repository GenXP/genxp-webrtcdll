...
namespace webrtc
{
    ...
    public:
        ...
        Context* CreateContext(int uid, GXPEncoderType encoderType, bool forTest);
    ...
    public:
        ...
        explicit Context(int uid = -1, GXPEncoderType encoderType = GXPEncoderHardware, bool forTest = false);
        ~Context();

        // Utility
        GXPEncoderType GetEncoderType() const;
